...
public class Vm {
	...
	public Vm(
		...
		setInMigration(vm.inMigration);
		setBeingInstantiated(vm.beingInstantiated);

		setCurrentAllocatedBw(vm.currentAllocatedBw);
		setCurrentAllocatedMips(vm.currentAllocatedMips);
		setCurrentAllocatedRam(vm.currentAllocatedRam);
		setCurrentAllocatedSize(vm.currentAllocatedSize);
		this.stateHistory.addAll(vm.stateHistory);
		this.host = vm.host;
	}
